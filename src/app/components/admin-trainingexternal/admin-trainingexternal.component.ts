...
@Component({
  selector: 'app-admin-trainingexternal',
  templateUrl: './admin-trainingexternal.component.html',
  styleUrls: ['./admin-trainingexternal.component.css']
})
export class AdminTrainingexternalComponent {
