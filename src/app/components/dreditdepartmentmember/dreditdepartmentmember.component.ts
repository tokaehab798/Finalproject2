...
@Component({
  selector: 'app-dreditdepartmentmember',
  templateUrl: './dreditdepartmentmember.component.html',
  styleUrls: ['./dreditdepartmentmember.component.css']
})
export class DreditdepartmentmemberComponent implements OnInit {
