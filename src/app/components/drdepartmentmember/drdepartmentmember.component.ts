...
@Component({
  selector: 'app-drdepartmentmember',
  templateUrl: './drdepartmentmember.component.html',
  styleUrls: ['./drdepartmentmember.component.css']
})
export class DrdepartmentmemberComponent implements OnInit {
